'use client'
import {Blink} from '@/components/shared/Blink'
...
export default function Loading() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="absolute left-8 md:left-16 lg:left-24 top-1/2 -translate-y-1/2 w-[200px] h-[300px] hidden md:block z-10">
        <Blink positionLeft="left-0" positionTop="top-0" />
        <Blink positionLeft="left-12" positionTop="top-16" />
        <Blink positionLeft="left-0" positionTop="top-32" />
        <Blink positionLeft="left-20" positionTop="top-48" />
        <Blink positionLeft="left-8" positionTop="top-64" />
        <Blink positionLeft="left-0" positionTop="top-80" />
        <Blink positionLeft="left-16" positionTop="top-96" />
        <Blink positionLeft="left-4" positionTop="top-112" />
        <Blink positionLeft="left-24" positionTop="top-128" />
        <Blink positionLeft="left-0" positionTop="top-144" />
        <Blink positionLeft="left-12" positionTop="top-160" />
        <Blink positionLeft="left-20" positionTop="top-176" />
      </div>
